...
#| label: country-codes-optional
#| echo: false
#| message: false
#| warning: false

# OPTIONAL stricter approach (only if your instructor requires it):
...
#   select(country_code)
#
# ind_latest <- ind_latest |> semi_join(country_codes, by = "country_code")
# pop_latest <- pop_latest |> semi_join(country_codes, by = "country_code")


### Checking the Number of Rows in`population` and `indicator`

#| label: check-rows-before
#| echo: false
#| message: false
#| warning: false
...
#| label: non-country-rows-note
#| echo: false
#| message: false
#| warning: false

# Non-country rows removed by filtering to 3-letter codes and excluding WLD.


### Checking the Number of Rows in the Reduced Tables

#| label: check-rows-after
#| echo: false
#| message: false
#| warning: false

nrow(ind_latest); nrow(pop_latest)
...
tibble(year = latest_year, total_countries = total_countries) |> gt()
top10 |> gt()
